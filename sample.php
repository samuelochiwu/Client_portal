...
<head>
  ...
  <title>Client console | Registration Page</title>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="../../index.html" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" required="required"  class="form-control" placeholder="Surname">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-user"></span>
            </div>
        ...
        <div class="input-group mb-3">
          <input type="text" required="required"  class="form-control" placeholder="Other Names">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" data-inputmask='"mask": "(999) 999-9999999"' data-mask>
          <div class="input-group-append">
            <div class="input-group-text">
