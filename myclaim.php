...
$url   = "http://35.189.125.141/demo_life/api_ies/ies_connect.php?process=myclaims";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> My Claim <small></small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="card">
          ...
          <div class="card-body table-responsive p-0">
            <table class="table table-striped table-valign-middle">
              ...
              <?php
              for($r0=0;$r0<=count($response);$r0++){
                
                $proposal   = $response['result'][$r0]['quoteid'];
                $entdate    = $response['result'][$r0]['entdate'];
                $totvalue   = $response['result'][$r0]['totvalue'];
                $totquote   = $response['result'][$r0]['totquote'];
                $propstatus = $response['result'][$r0]['propstatus'];
